...
<!-- Message -->
<a href="#">
<div class="user-img"> <img <?php echo ('src="assets/images/users/'.$uimg.'"');?> alt="user" class="img-circle">  <span class="profile-status online"></span> </div>
<div class="mail-contnet">
<h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:30 AM</span> </div>
</a>
<!-- Message -->
<a href="#">
<div class="user-img"> <img src="assets/images/users/2.jpg" alt="user" class="img-circle"> <span class="profile-status busy"></span> </div>
<div class="mail-contnet">
<h5>Sonu Nigam</h5> <span class="mail-desc">I've sung a song! See you at</span> <span class="time">9:10 AM</span> </div>
</a>
<!-- Message -->
<a href="#">
<div class="user-img"> <img src="assets/images/users/3.jpg" alt="user" class="img-circle"> <span class="profile-status away"></span> </div>
<div class="mail-contnet">
<h5>Arijit Sinh</h5> <span class="mail-desc">I am a singer!</span> <span class="time">9:08 AM</span> </div>
</a>
<!-- Message -->
<a href="#">
<div class="user-img"> <img src="assets/images/users/4.jpg" alt="user" class="img-circle"> <span class="profile-status offline"></span> </div>
<div class="mail-contnet">
<h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:02 AM</span> </div>
</a>
</div>
...
<li class="nav-item dropdown">
<a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 
 <img <?php echo('src="assets/images/users/'.$uimg.'"');?> 
...
<div class="u-img"><img <?php echo('src="assets/images/users/'.$uimg.'"');?> alt="user"></div>
<div class="u-text">
<h4><?php echo($name); ?></h4>
<p class="text-muted"><?php echo ($_SESSION['user']);  ?>
...
<div class="profile-img"> 
     <?php
echo('<div class="profile-img"> <img src="assets/images/users/'.$uimg.'" alt="user" />');
                     ?>
...
<li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-file-chart"></i><span class="hide-menu">Property</span></a>
<ul aria-expanded="false" class="collapse">
<li><a href="add_property.php">Add Property</a></li>
<li><a href="chart-chartist.html">View Property</a></li>
